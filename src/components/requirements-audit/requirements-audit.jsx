...
class requirementsAudit extends Component {
    ...
    onAccept(searchResult) {
        this.props.history.push({
            pathname: '/accept-requirements-audit',
    ...
    search = async (parameters) => {
        try {
            const result = await searchProduct(Object.assign(parameters, {
...
export default withRouter(requirementsAudit);
