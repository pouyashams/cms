...
import {acceptReturnProduct, productDetails} from "../../services/menu-product-info-management"
import SearchResult from "../search/search-result";

class acceptRejectReturnProduct extends Component {
    ...
    acceptReturnProductInfo = async () => {
        const result = await acceptReturnProduct();
        try {
    ...
    async componentDidMount() {
        ...
        this.setState({
            ...
            canAcceptOrRejectReturnProduct: this.getValue(dataInfo.canAcceptOrRejectReturnProduct),
        ...
        return (
            <div
                ...
                <div className="col-12 justify-content-center align-items-center text-center header-box text-light">
                    <h4 className="py-2">تایید عودت</h4>
                </div>
                        ...
                        {this.state.canAcceptOrRejectReturnProduct === true ?
                            <div className="col-12 text-center justify-content-center row align-items-center my-3">
                                <div className="px-3">
                                    ...
                                    <input type="button" className="btn btn-primary" value="تایید عودت"
                                           onClick={this.acceptReturnProductInfo}/>
                                </div>
                                <div className="px-3">
                            ...
                            <div className="col-12 text-center justify-content-center">
                                ...
                                <h6 className="p-2 font-weight-bold">(قادر به تایید یا لغو عودت نمی باشید)</h6>
                            </div>
                        }
...
export default withRouter(acceptRejectReturnProduct);
